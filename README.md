# Building a next generation Lisp operating system
...
Follow me on GitHub to keep track of my contributions to various Lisp userspace codebases! Development on GNU itself is limited to the official mailing lists for each project.
